...
export default function FiguartsPage() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-red-50 via-white to-yellow-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-red-800 dark:text-red-200 mb-3">

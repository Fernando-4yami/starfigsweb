...
const config = categoryConfigs.pricing
...
export default function PricingPage() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-violet-800 dark:text-violet-200 mb-3">
      ...
      <CategoryPage config={categoryConfigs.pricing} />
    </>
  )
}

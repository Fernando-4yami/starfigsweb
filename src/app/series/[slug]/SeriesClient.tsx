...
export default function SeriesClient({ seriesName, products }: SeriesClientProps) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-8">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-blue-600 dark:text-blue-400 font-medium">{seriesName}</span>
        </nav>

        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">
            Figuras de {seriesName}
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            {products.length} {products.length === 1 ? "figura disponible" : "figuras disponibles"} de {seriesName}
          </p>
        </div>
        ...
        {sortedProducts.length === 0 ? (
          <div className="text-center py-16 bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              No tenemos figuras de {seriesName} en este momento, pero siempre estamos actualizando nuestro catálogo.
            </p>
            <a
        ...
        <div className="mt-16 text-center text-sm text-gray-500 dark:text-gray-500 border-t border-gray-200 dark:border-gray-700 pt-8">
          <p className="max-w-3xl mx-auto leading-relaxed">
            Compra figuras de {seriesName} originales en Starfigs Perú. 
            Contamos con Nendoroid, Figma, S.H.Figuarts, Ichiban Kuji, Pop Up Parade y más formatos de {seriesName}. 
            Todas nuestras figuras son originales importadas desde Japón con envío gratis a todo el Perú por Agencias Shalom.
          </p>
        </div>
      </div>
    </div>
